...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] max-sm:min-h-auto flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="text-white max-sm:text-2xl text-4xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
            We Will Build Services and Product base requirement of. <br /> your Company.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
